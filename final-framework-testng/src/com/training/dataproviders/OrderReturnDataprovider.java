...
import com.training.readexcel.ApachePOIOrderReturnRead;


public class OrderReturnDataprovider {
	...
	public Object[][] getExcelData(){
		...
		return new ApachePOIOrderReturnRead().getExcelContent(fileName); 
	}
